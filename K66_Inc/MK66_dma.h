...
#define  DMA_IRQ_EN(DMA_CHn)    enable_irq((IRQn_t)((IRQn_t)DMA_CHn + DMA0_DMA16_IRQn))               //允许DMA通道传输完成中断
#define  DMA_IRQ_DIS(DMA_CHn)   disable_irq((IRQn_t)((IRQn_t)DMA_CHn + DMA0_DMA16_IRQn))              //禁止DMA通道传输完成中断
