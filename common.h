...
typedef enum
{
    ...
    DMA0_DMA16_IRQn                 = 0,        // DMA Channel 0 Transfer Complete
    DMA1_DMA17_IRQn                       = 1,        // DMA Channel 1 Transfer Complete
    DMA2_DMA18_IRQn                       = 2,        // DMA Channel 2 Transfer Complete
    DMA3_DMA19_IRQn                       = 3,        // DMA Channel 3 Transfer Complete
    DMA4_DMA20_IRQn                       = 4,        // DMA Channel 4 Transfer Complete
    DMA5_DMA21_IRQn                       = 5,        // DMA Channel 5 Transfer Complete
    DMA6_DMA22_IRQn                       = 6,        // DMA Channel 6 Transfer Complete
    DMA7_DMA23_IRQn                       = 7,        // DMA Channel 7 Transfer Complete
    DMA8_DMA24_IRQn                       = 8,        // DMA Channel 8 Transfer Complete
    DMA9_DMA25_IRQn                       = 9,        // DMA Channel 9 Transfer Complete
    DMA10_DMA26_IRQn                      = 10,       // DMA Channel 10 Transfer Complete
    DMA11_DMA27_IRQn                      = 11,       // DMA Channel 11 Transfer Complete
    DMA12_DMA28_IRQn                      = 12,       // DMA Channel 12 Transfer Complete
    DMA13_DMA29_IRQn                      = 13,       // DMA Channel 13 Transfer Complete
    DMA14_DMA30_IRQn                      = 14,       // DMA Channel 14 Transfer Complete
    DMA15_DMA31_IRQn                      = 15,       // DMA Channel 15 Transfer Complete
...
typedef enum
{
    ...
    */
    ...
    DMA15_DVECTORn                      = 31,       // DMA Channel 15/31 Transfer Complete
